...
public:
	...
	virtual RHIRef<RHIGraphicsPipeline> createGraphicsPipeline(const RHIGraphicsPipelineDesc& desc) = 0;
	virtual RHIRef<RHIComputePipeline> createComputePipeline(const RHIComputePipelineDesc& desc) = 0;
