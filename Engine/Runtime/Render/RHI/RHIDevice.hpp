...
public:
	...
	virtual void  bindBufferMemory(RHIBuffer* buffer, uint64_t offset = {}) const noexcept = 0;
	virtual void  bindTextureMemory(RHITexture* texture, uint64_t offset = {}) const noexcept = 0;
